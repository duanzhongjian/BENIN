...
teacher_ckpt = 'https://download.openmmlab.com/mmclassification/v0/resnet/resnet34_b16x8_cifar10_20210528-a8aa36a6.pth'  # noqa: E501
...
model = dict(
    ...
    teacher=dict(
        cfg_path='mmcls::resnet/resnet34_8xb16_cifar10.py', pretrained=True),
