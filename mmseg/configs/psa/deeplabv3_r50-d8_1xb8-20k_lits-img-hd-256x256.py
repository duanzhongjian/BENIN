_base_ = [
    '../_base_/models/deeplabv3_r50-d8.py', '../_base_/datasets/lits_img_hd.py',
...
default_hooks = dict(
    visualization=dict(type='SegVisualizationHook', draw_table=True, interval=1000),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='LITS-img-hd', name='resnet-20k'),
