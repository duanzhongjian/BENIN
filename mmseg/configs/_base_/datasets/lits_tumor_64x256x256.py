# dataset settings
dataset_type = 'LITS_Tumor_Dataset'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='images_tumor/training',
            seg_map_path='annotations_tumor/training'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='images_tumor/validation',
            seg_map_path='annotations_tumor/validation'),
