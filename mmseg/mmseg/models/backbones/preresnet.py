...
class PreResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv_fcn1 = ConvModule(2048,
                                    512,
                                    kernel_size=3,
                                    padding=1,
                                    dilation=1,
