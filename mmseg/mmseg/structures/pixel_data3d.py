...
class PixelData3D(BaseDataElement):
    ...
    Examples:
        ...
        ...     img_shape=(random.randint(400, 600), random.randint(400, 600), random.randint(400, 600)))
        >>> image = np.random.randint(0, 255, (1, 4, 20, 40))
        >>> featmap = torch.randint(0, 255, (5, 10, 20, 40))
        >>> pixel_data = PixelData3D(metainfo=metainfo,
        ...                        image=image,
        ...                        featmap=featmap)
        >>> print(pixel_data)
        >>> (20, 40)
    ...
    def __getitem__(self, item: Sequence[Union[int, slice]]) -> 'PixelData3D':
        """
        Args:
