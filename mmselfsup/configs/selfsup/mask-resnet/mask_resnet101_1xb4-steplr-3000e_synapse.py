...
# optimizer_wrapper
optimizer = dict(type='AdamW', lr=1.5e-6, betas=(0.9, 0.95), weight_decay=0.0005)
...
param_scheduler = [
    ...
    dict(
        type='CosineAnnealingLR', T_max=2960, by_epoch=True, begin=40, end=3000)
]

# runtime settings
# pre-train for 1000 epochs
train_cfg = dict(max_epochs=3000)
default_hooks = dict(
